package br.com.isaguiar.service;
...
import br.com.isaguiar.model.Pessoa;
import br.com.isaguiar.repository.PessoaRepository;
import br.com.isaguiar.repository.entity.PessoaEntity;
...
public class PessoaService {
    ...
    public Pessoa GetPessoa(@PathParam("codigo") Integer codigo) {
        ...
        if (entity != null) return new Pessoa(entity.getCodigo(), entity.getNome(), entity.getSexo());
