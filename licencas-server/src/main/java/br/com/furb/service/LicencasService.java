...
//
//			return new LicencaResponse(1, "Categoria cadastrada com sucesso.", categoria);
//		} catch (Exception e) {
//			return new LicencaResponse(0, "Erro ao cadastrar a categoria.", e.getMessage(), categoria);
//		}
//	}
//
//	@PUT
...
//			repository.persist(entity);
//
//			return new LicencaResponse(1, "Categoria alterada com sucesso.", categoria);
//		} catch (Exception e) {
//			return new LicencaResponse(0, "Erro ao alterar a categoria.", e.getMessage(), categoria);
//		}
//	}
...
//		} catch (Exception e) {
//			return new LicencaResponse(0, "Erro ao excluir a Categoria.", e.getMessage(), null);
//		}
//	}
}
